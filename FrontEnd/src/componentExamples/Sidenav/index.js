...
import SidenavCollapse from "componentExamples/Sidenav/SidenavCollapse";
import SidenavCard from "componentExamples/Sidenav/SidenavCard";

// Custom styles for the Sidenav
import SidenavRoot from "componentExamples/Sidenav/SidenavRoot";
import sidenavLogoLabel from "componentExamples/Sidenav/styles/sidenav";
...
function Sidenav({ color, brandName, routes, ...rest }) {
  ...
  var renderRoutes = routes.map(({ type, name, icon, title, noCollapse, key, route, href }) => {
    let returnValue;
